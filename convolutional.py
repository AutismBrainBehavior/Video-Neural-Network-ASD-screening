...
from frame_extractor import scan_and_extract_videos_for_conv2d, \
...
class CnnVideoClassifier(object):
    ...
    def fit(self, data_dir_path, model_dir_path, epochs=NUM_EPOCHS, data_set_name='autism_data', max_frames=100000,
            test_size=0.3,
            random_state=42):
