...
def main():
    ...
    data_dir_path = os.path.join(os.path.dirname(__file__), 'very_large_data/autism_data_test')
    model_dir_path = os.path.join(os.path.dirname(__file__), 'models', 'autism_data')
